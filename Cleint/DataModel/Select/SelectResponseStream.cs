...
public class SelectResponseStream
{
    ...
    private void Start()
    {
        ...
        while (_isProcessing)
        {
            ...
            var isValidPrelude = System.IO.Hashing.Crc32.TryHash(inputArray.Slice(0, inputArray.Length - 4), destinationPrelude, out _);
            ...
            var isValidMessage = System.IO.Hashing.Crc32.TryHash(inputArray.Slice(0, inputArray.Length - 4), destinationMessage, out _);
